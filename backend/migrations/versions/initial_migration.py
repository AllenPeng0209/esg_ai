...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_workflow_nodes_node_id'), 'workflow_nodes', ['node_id'], unique=False)
    ...
    op.create_index(op.f('ix_workflow_edges_edge_id'), 'workflow_edges', ['edge_id'], unique=False)
