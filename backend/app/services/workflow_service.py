...
def get_workflow_by_id(db: Session, workflow_id: int, user_id: Optional[int] = None) -> Optional[Workflow]:
...
def update_workflow(db: Session, workflow_id: int, workflow_data: WorkflowUpdate, user_id: int) -> Optional[Workflow]:
    """更新工作流"""
