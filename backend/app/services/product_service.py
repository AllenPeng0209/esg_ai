...
def get_product_by_id(db: Session, product_id: int, user_id: Optional[int] = None) -> Optional[Product]:
    """获取产品，可选择只获取特定用户的产品"""
...
def update_product(db: Session, product_id: int, product_data: ProductUpdate, user_id: int) -> Optional[Product]:
    """更新产品"""
